...
/obj/item/kinetic_crusher/premiumcrusher
	icon = 'modular_sand/icons/obj/mining.dmi'
	lefthand_file = 'modular_sand/icons/mob/inhands/weapons/hammerspc_lefthand.dmi'
	righthand_file = 'modular_sand/icons/mob/inhands/weapons/hammerspc_righthand.dmi'
