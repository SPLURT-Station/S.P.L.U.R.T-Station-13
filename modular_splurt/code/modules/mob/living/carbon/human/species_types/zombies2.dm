...
// takes 20% more damage and 10% slower but doesn't crit has low light with heavy flash negative this is now baseline across them all. undead is undead.
	...
	inherent_traits = list(TRAIT_BRAINLOVER,TRAIT_NOPULSE,TRAIT_STABLEHEART,TRAIT_RESISTCOLD,TRAIT_NOBREATH,TRAIT_RESISTLOWPRESSURE,TRAIT_RESISTHIGHPRESSURE,TRAIT_RADIMMUNE,TRAIT_EASYDISMEMBER,TRAIT_LIMBATTACHMENT,TRAIT_NOSOFTCRIT,TRAIT_NOHARDCRIT,TRAIT_FAKEDEATH)
...
/datum/species/insect/undead
	...
	cold_offset = SYNTH_COLD_OFFSET
	species_traits = list(DRINKSBLOOD,NOZOMBIE,NOTRANSSTING,MUTCOLORS,EYECOLOR,LIPS,HAIR,HORNCOLOR,WINGCOLOR,CAN_SCAR,HAS_FLESH,HAS_BONE)
	inherent_traits = list(TRAIT_BRAINLOVER,TRAIT_NOPULSE,TRAIT_STABLEHEART,TRAIT_NOBREATH,TRAIT_RESISTCOLD,TRAIT_RESISTLOWPRESSURE,TRAIT_RESISTHIGHPRESSURE,TRAIT_RADIMMUNE,TRAIT_EASYDISMEMBER,TRAIT_LIMBATTACHMENT,TRAIT_NOHARDCRIT,TRAIT_NOSOFTCRIT,TRAIT_FAKEDEATH)
