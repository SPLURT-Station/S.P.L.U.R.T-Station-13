...
/obj/machinery/self_actualization_device
	...
	icon = 'modular_splurt/nopeengineer/self_actualization_device/icons/self_actualization_device.dmi'
	icon_state = "sad_open"
...
// BLUEMOON ADD START - if a character is wearing a normalizer, he cannot get inside/complete the procedure (otherwise it leads to errors with setting the size)
