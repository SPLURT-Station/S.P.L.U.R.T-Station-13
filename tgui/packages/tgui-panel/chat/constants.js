...
export const MESSAGE_TYPES = [
  ...
  },
  {
    ...
    selector: '.alert, .minorannounce, .syndradio, .centcomradio, .aiprivradio, .comradio, .corradio .secradio, .gangradio, .engradio, .medradio, .sciradio, .suppradio, .servradio, .radio, .deptradio, .binarysay, .newscaster, .resonate',
  },
  {
